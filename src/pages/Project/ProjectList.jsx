          ...
          <Card className="p-5 sticky top-10">
            ...
            <CardContent className="mt-5 ">
              <ScrollArea className="space-y-7 h-[70vh]">
                <div>
                  <h1 className="pb-3 text-gray-900 font-bold">Danh mục</h1>
                  <div className="pt-5">
                    <RadioGroup
                      onValueChange={(value) =>
                    ...
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="thuong_mai" id="r3" />
                      <Label htmlFor="r3">Công trình thương mại</Label>
                    </div>  
                    </RadioGroup>
                  </div>
                </div>
                ...
                <div className="pt-9">
                  <h1 className="pb-3 text-gray-900 font-bold">Nhãn</h1>
