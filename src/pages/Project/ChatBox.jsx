...
import { toast } from "sonner"; // Thêm import này nếu bạn sử dụng toast
...
const ChatBox = () => {
  ...
  const handleSendMessage = () => {
    ...
    if (!message || message.trim() === "") {
      // Tùy chọn: hiển thị thông báo nếu bạn muốn
      toast?.error("Không thể gửi tin nhắn trống");
      return; // Không thực hiện gửi tin nhắn
    }

    // Chỉ gửi tin nhắn khi không rỗng
    dispatch(
      sendMessage({
        message: {
          senderId: auth.user?.id,
          projectId: id,
          content: message.trim(), // Loại bỏ khoảng trắng thừa
        },
  ...
  return (
    <div className="sticky">
      <div className="border rounded-lg">
        <h1 className="border-b p-5">Trò chuyện</h1>
        ...
        <div className="relative p-0">
          ...
          <Button
            ...
            size="icon"
            variant="ghost"
            disabled={!message.trim()} // Vô hiệu hóa nút khi tin nhắn trống
          >
            <PaperPlaneIcon
